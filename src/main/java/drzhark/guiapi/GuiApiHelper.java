...
public class GuiApiHelper {
     ...
     * @param showBackButton Whether to automatically show a 'back' button or
     *        not.
     * @param autoBack Whether to automatically merge a 'back' ModAction with
     *        the buttons.
     * @param args The button information. Enter it in the form of String (Name
     *        on the button), ModAction (The ModAction to call when the button
     *        is pressed).
     ...
     * @param autoBack Whether to automatically merge a 'back' ModAction with
     *        the buttons.
     * @param buttonTexts The text for the buttons you want to show.
     * @param buttonActions The corresponding ModActions for the buttons.
     * @return The generated widget. Use GuiModScreen.show to display it.
     */
    public static Widget createChoiceMenu(String displayText, Boolean showBackButton, Boolean autoBack, String[] buttonTexts,
     ...
     * @param action The ModAction to call when clicked.
     * @param addClick Set this to true and it will automatically play the Click
     *        sound.
     ...
     *
     * @param displayText The text to display on the button.
     * @param methodName The name of the method to call when clicked.
     * @param me The Object or Class that has the method you want to call.
     * @param addClick Set this to true and it will automatically play the Click
     *        sound.
     * @return The new Button widget.
     */
    public static Button makeButton(String displayText, String methodName, Object me, Boolean addClick) {
        return GuiApiHelper.makeButton(displayText, new ModAction(me, methodName), addClick);
    }
     ...
     * @param addClick Set this to true and it will automatically play the Click
     *        sound.
     * @param classes The argument classes for the method you want to call.
     * @param arguments The defaulted arguments you want to use.
     * @return The new Button widget.
     */
     ...
     * @param htmlMode Whether to create the Textbox to render HTML, or standard
     *        text.
     ...
     * information notices.
     *
     * @param titleText This is the text for the title on top of the display. If
     *        you set this to null, it will simply not have a top bar.
     * @param displayText This is the text to be displayed below the title bar
     *        (If there is one).
     * @param buttonText This is the text you want the back button to have.
     *        Something like 'OK' or 'Back' is what you usually use.
     * @param htmlMode This is if you want the text to be rendered as if it were
     *        HTML.
     * @return The generated widget. Use GuiModScreen.show to display it.
     */
     ...
     *
     * @param textArea The TextArea you wish to set the text of.
     ...
     * @param action The action to use when pressed.
     * @param mergeBack Whether or not to automatically to back after the button
     *        is pressed.
     */
     ...
     * @param me The object or class with the method you wish to call.
     * @param mergeBack Whether or not to automatically to back after the button
     *        is pressed.
     */
     ...
     * @param methodName The method to call.
     * @param me The object or class with the method you wish to call.
     * @param types The types of the arguments required for the method.
     * @param mergeBack Whether or not to automatically to back after the button
     *        is pressed.
     * @param arguments The arguments you wish to use when this button is
     *        pressed.
     */
    @SuppressWarnings("rawtypes")
    public void addButton(String text, String methodName, Object me, Class[] types, Boolean mergeBack, Object... arguments) {
        addButton(text, new ModAction(me, methodName, types).setDefaultArguments(arguments), mergeBack);
    }
     ...
     *
     * @param showBackButton If true, show a bar on the bottom with a button to
     *        go back to the previous menu. If false, don't.
     * @return The generated widget. Use GuiModScreen.show to display it.
     */
    public WidgetSimplewindow genWidget(Boolean showBackButton) {
        ...
        for (AbstractMap.SimpleEntry<String, ModAction> entry : this.buttonInfo_) {
            widget.add(GuiApiHelper.makeButton(entry.getKey(), entry.getValue(), true));
        }
