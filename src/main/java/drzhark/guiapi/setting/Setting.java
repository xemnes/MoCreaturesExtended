 ...
 *
 * @author lahwran
 * @param <T> The type that this Setting will use.
 */
public abstract class Setting<T> extends Widget {
     ...
     *
     * @param srccontext The source context to copy data from.
     * @param destcontext The destination context you would like to save the
     *        data to.
     */
