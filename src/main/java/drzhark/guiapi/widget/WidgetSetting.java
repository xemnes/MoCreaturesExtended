...
public abstract class WidgetSetting extends Widget {
     ...
     *
     * @param nicename The nice name for this WidgetSetting.
     */
     ...
     *
     * @param paramRunnable The Runnable callback you wish to call if the value
     *        changes.
     */
     ...
     *
     * @param paramRunnable The Runnable callback you wish to remove.
     */
