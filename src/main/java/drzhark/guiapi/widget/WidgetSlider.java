...
public class WidgetSlider extends ValueAdjusterFloat {
     ...
     * constructor, as well as adding an option to allow editing the value with
     * text.
     *
     * @param f The FloatModel to use.
     */
    ...
    /**
     * Specifies whether or not to allow the user to click on the Slider to
    ...
    /**
     * @return True if the user can edit this Slider by clicking on it: False
     *         otherwise.
     */
