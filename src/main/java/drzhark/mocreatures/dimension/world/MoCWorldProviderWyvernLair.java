...
import drzhark.mocreatures.dimension.MoCSkyRenderer;
...
import drzhark.mocreatures.dimension.chunk.MoCChunkGeneratorWyvernSkylands;
...
public class MoCWorldProviderWyvernLair extends WorldProviderSurface {

    @Override
    protected void init() {
        this.biomeProvider = new MoCBiomeProviderWyvernLair(MoCBiomes.WyvernLairBiome, 0.5F, 0.0F);
    ...
    public IChunkGenerator createChunkGenerator() {
        return FMLLaunchHandler.isDeobfuscatedEnvironment() ? new MoCChunkGeneratorWyvernSkylands(this.world, this.world.getSeed()) : new MoCChunkGeneratorWyvernLair(this.world, false, this.world.getSeed());
    }
