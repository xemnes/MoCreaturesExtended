...
public class MoCEntities {
    ...
    public static void registerEntities() {
        ...
        MoCreatures.mocEntityMap.put("Bird", new MoCEntityData("Bird", 4, overworld, EnumCreatureType.CREATURE, new SpawnListEntry(MoCEntityBird.class, 16, 2, 3), new ArrayList<>(Arrays.asList(Type.FOREST, Type.JUNGLE, Type.PLAINS, Type.MESA, STEEP))));
        ...
        MoCreatures.mocEntityMap.put("Duck", new MoCEntityData("Duck", 3, overworld, EnumCreatureType.CREATURE, new SpawnListEntry(MoCEntityDuck.class, 12, 1, 2), new ArrayList<>(Arrays.asList(Type.RIVER, Type.LUSH))));
        ...
        MoCreatures.mocEntityMap.put("Turtle", new MoCEntityData("Turtle", 3, overworld, EnumCreatureType.CREATURE, new SpawnListEntry(MoCEntityTurtle.class, 11, 1, 2), new ArrayList<>(Arrays.asList(Type.SWAMP, Type.RIVER))));
