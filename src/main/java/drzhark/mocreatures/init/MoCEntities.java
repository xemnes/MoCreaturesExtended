...
public class MoCEntities {
    ...
    public static void registerEntities() {
        ...
        MoCreatures.mocEntityMap.put("CaveScorpion", new MoCEntityData("CaveScorpion", 3, overworld, EnumCreatureType.MONSTER, new SpawnListEntry(MoCEntityCaveScorpion.class, 6, 1, 3), new ArrayList<>(Arrays.asList(Type.SANDY, Type.SNOWY, Type.MESA, Type.DRY, Type.HOT, Type.SPOOKY, Type.WASTELAND))));
        ...
        MoCreatures.mocEntityMap.put("UndeadScorpion", new MoCEntityData("UndeadScorpion", 3, overworld, EnumCreatureType.MONSTER, new SpawnListEntry(MoCEntityUndeadScorpion.class, 6, 1, 3), new ArrayList<>(Arrays.asList(Type.SPOOKY, Type.WASTELAND))));
